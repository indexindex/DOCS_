...
let unwantedExperiences = [
                           "what if i fail my dreams", 
                           "what if i can't achieve this", 
                           "what if i loose it"
                          ];

if (unwantedExperiences.length > 0) {
  unwantedExperiences.forEach(worry => {
    console.log(`New worry you need to fix is '${worry}?'`);
  })
}

// ? OUTPUT >
// * New worry you need to fix is 'what if i fail my dreams?' debugger eval code:5:13
// * New worry you need to fix is 'what if i can't achieve this?' debugger eval code:5:13
// * New worry you need to fix is 'what if i loose it?'
